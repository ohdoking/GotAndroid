...
package com.minder.gotandroid.write;
 ...
 * {@link Places#GEO_DATA_API} API. /** Adapter that handles Autocomplete
 * requests from the Places Geo Data API. Results are encoded as
 * objects that contain both the Place ID and the text description from the
 * autocomplete query.
 * <p>
 * Note that this adapter requires a valid
